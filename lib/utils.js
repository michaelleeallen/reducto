...
/**
 * Searches the given Object for daa located at the key path.
 * @param {Object} obj 
 * @param {String} path - dot-separated Object key path
 * @returns {any}
 */
exports.getAtPath = function (obj, path) {
  const keys = path.split('.');
  const data = keys.reduce((val, curr) => {
    return val[curr];
  }, obj);
...
/**
 * Sets the given value at the given key path in the given Object.
 * @param {Object} obj 
 * @param {String} path 
 * @param {any} value 
 */
